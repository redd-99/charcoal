import{r as w,j as r,t as a,q as t,u as g}from"./iframe-DJsPqc0f.js";import"./preload-helper-C1FmrZbK.js";const x=w.forwardRef(function({gtmClass:i,flex:b=!1,rowReverse:s=!1,children:c,disabled:l,...f},m){return r.jsxs(y,{className:i!==void 0?`gtm-${i}`:"",flex:b,rowReverse:s,"aria-disabled":l,children:[r.jsxs($,{children:[r.jsx(S,{...f,disabled:l,ref:m}),r.jsx(n,{children:r.jsx(h,{})})]}),c!=null&&r.jsx(k,{rowReverse:s,children:c})]})}),k=t.span`
  ${e=>e.rowReverse?a`
          margin-right: 8px;
        `:a`
          margin-left: 8px;
